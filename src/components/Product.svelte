    ...
    >
        <div class="flex flex-col gap-2">
            <p class="opacity-60 text-base sm:text-lg md:text-xl text-center">
                <span class="text-indigo-400">Kabaddi</span> is the best game in
                the world.
            </p>
            <h3
                class="text-4xl sm:text-5xl md:text-6xl max-w-[1000px] mx-auto w-full font-semibold"
            >
                Features that make <span class="text-indigo-400">Kabaddi</span>
            </h3>
        </div>
